...
interface TransactionIconCartaoFalhadoProps {
  width?: number;
  height?: number;
}

export default function TransactionIconCartaoFalhado({ width = 48, height = 49 }: TransactionIconCartaoFalhadoProps) {
  return (
